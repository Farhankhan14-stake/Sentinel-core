...
export const ReasoningWindow = ({ reasoningLogs }: ReasoningWindowProps) => {
  ...
  return (
    <div className="reasoning-window bg-slate-900/40 border border-indigo-500/20 rounded-xl flex flex-col h-[500px] p-4 shadow-[0_0_15px_rgba(99,102,241,0.1)]">
      <h3 className="text-lg font-semibold mb-4 text-slate-100">Live AI Reasoning</h3>
      <div className="log-container flex-1 overflow-y-auto space-y-3 bg-[#0d1117] p-4 rounded-lg border border-white/5">
