        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-1 border-t border-white/10">
              <Link to="/" className="flex items-center px-3 py-2 text-sm text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-md transition-colors" onClick={() => setIsOpen(false)}>
