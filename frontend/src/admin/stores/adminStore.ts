...
export const useAdminStore = create<AdminState>((set) => ({
  ...
  apiKeys: [
    { id: 'key_1', userId: 'usr_1', userEmail: 'admin@acme.com', prefix: 'sk_live_acme', usage: 1250000, lastUsed: '2 mins ago', status: 'ACTIVE' },
    { id: 'key_2', userId: 'usr_2', userEmail: 'dev@startup.io', prefix: 'sk_live_strt', usage: 45000, lastUsed: '1 hour ago', status: 'ACTIVE' },
    { id: 'key_3', userId: 'usr_3', userEmail: 'hacker@anon.net', prefix: 'sk_live_hack', usage: 1000, lastUsed: '5 days ago', status: 'REVOKED' },
  ],
  logs: [
