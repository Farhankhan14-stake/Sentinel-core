...
import { ShieldAlert, Send, Loader2, Settings2, Activity, Terminal } from 'lucide-react';
...
export default function Playground() {
  ...
  const [securityTier, setSecurityTier] = useState('PRO');
            ...
            <CardContent className="flex-1 p-0 overflow-y-auto bg-[#0d1117]">
              {!result && !isScanning && (
                <div className="h-full flex flex-col items-center justify-center text-slate-500 space-y-4">
                  ...
                  <p>Run a scan to see the security analysis and execution trace.</p>
                </div>
              )}
