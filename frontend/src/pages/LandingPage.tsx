      ...
      <main>
          ...
          <div className="text-center max-w-4xl mx-auto relative z-10">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 leading-tight">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">The Intelligent Firewall for the LLM Era.</span>
              </h1>
              ...
              <div className="rounded-xl border border-white/10 bg-slate-900/80 backdrop-blur-xl shadow-2xl overflow-hidden">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-slate-950/50 border border-white/5 rounded-lg p-4">
                    ...
                    <div className="text-xs text-[#FF4D4D] mt-1">+12% this week</div>
                  </div>
                  <div className="bg-slate-950/50 border border-white/5 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm text-slate-400">Security Score</span>
                      <Activity className="w-4 h-4 text-[#32FF7E]" />
                    </div>
                    <div className="text-3xl font-bold text-[#32FF7E]">98/100</div>
                  ...
                  <div className="bg-slate-950/50 border border-white/5 rounded-lg p-4">
                    ...
                    <div className="space-y-2 mt-3">
                      <div className="flex items-center justify-between text-xs font-mono">
                        ...
                        <span className="text-[#FF4D4D] bg-[#FF4D4D]/10 px-2 py-0.5 rounded">BLOCKED</span>
                      </div>
                      <div className="flex items-center justify-between text-xs font-mono">
                        <span className="text-slate-500">10:41:55</span>
                        <span className="text-[#32FF7E] bg-[#32FF7E]/10 px-2 py-0.5 rounded">CLEAN</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-slate-900/40 border border-white/10 rounded-xl p-6 backdrop-blur-sm hover:bg-slate-900/60 transition-colors">
                <div className="w-12 h-12 rounded-lg bg-[#FF4D4D]/10 flex items-center justify-center mb-4 border border-[#FF4D4D]/20">
              ...
              <div className="bg-slate-900/40 border border-white/10 rounded-xl p-6 backdrop-blur-sm hover:bg-slate-900/60 transition-colors">
                <div className="w-12 h-12 rounded-lg bg-[#FFC857]/10 flex items-center justify-center mb-4 border border-[#FFC857]/20">
        ...
        <section id="how-it-works" className="py-32 px-6 max-w-7xl mx-auto">
          ...
          <div className="relative max-w-4xl mx-auto">
            {/* Connecting Line */}
            <div className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 bg-gradient-to-r from-slate-800 via-indigo-500/50 to-slate-800 -translate-y-1/2 z-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-[#32FF7E]/10 border border-[#32FF7E]/30 flex items-center justify-center mb-4 shadow-[0_0_20px_rgba(50,255,126,0.1)]">
                  <CheckCircle2 className="w-6 h-6 text-[#32FF7E]" />
                </div>
              ...
              {[
                ...
                <div key={i} className="group p-6 rounded-xl bg-slate-950/50 border border-white/5 hover:border-indigo-500/30 hover:bg-slate-900/80 transition-all duration-300">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 rounded-lg bg-slate-800 flex items-center justify-center flex-shrink-0 group-hover:bg-indigo-500/20 group-hover:text-indigo-400 transition-colors">
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto overflow-hidden">
          <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              <ul className="space-y-4 pt-4">
                {[
                  ...
                  <li key={i} className="flex items-start space-x-3">
                    <CheckCircle2 className="w-5 h-5 text-[#32FF7E] flex-shrink-0 mt-0.5" />
            ...
            <div className="lg:w-1/2 relative">
              <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 to-cyan-500/20 blur-[80px] -z-10" />
      ...
      <footer className="bg-slate-950 border-t border-white/5 py-12">
        ...
        <div className="max-w-7xl mx-auto px-6 mt-12 pt-8 border-t border-white/5 text-sm text-slate-600 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 rounded-full bg-[#32FF7E]" />
